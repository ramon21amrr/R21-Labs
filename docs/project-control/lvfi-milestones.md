...
| 19 | Match Center e autenticação local | Match Center concluído, publicado, integrado e encerrado institucionalmente; autenticação sem task autorizada | `LVFI-APP-016`, PR #44/merge `c2d67e5c6c9f4ab273628f9b67ab26d5ea7f40f5` | Jornada pessoal por partida disponível; proteção server-side continua pendente de autorização |
