...
| 20 | PDF-resumo e operação local | Concluído, publicado, integrado e encerrado institucionalmente | `LVFI-APP-018`, PR #48, merge `80e785c7a8e6f2b8b111a6c56e6a6c97092647db` | PDF Chromium de snapshot aprovado; launcher; backup/restauração ensaiados, RPO 408,86 s e RTO 5,62 s |
