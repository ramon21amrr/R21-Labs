# Bootstrap para novo chat do LVFI

Anexe no mínimo `lvfi-session-handoff.md` e `lvfi-project-state.yaml`, ou apenas
`LVFI-CHAT-HANDOFF.md`, e use este prompt:
...
apresente apenas uma ação imediata por vez, em linguagem simples.

Sempre informe: Modelo; Esforço; Agente; Modo; Onde; Mesma tarefa ou nova tarefa;
Ação única; O que conclui; Próximo passo.
```
