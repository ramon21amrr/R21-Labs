...
| ID e autorização da fundação operacional de dados | Pendente; primeira decisão após a integração da R21-GOV-002 | Product Owner/CTO | Bloqueia iniciar código do plano mestre | `GOV-D-010–017`; [documento 39](../products/linha-de-valor-football-intelligence/39-lvfi-master-plan-rebaseline.md) |
