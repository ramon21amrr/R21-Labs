...
| `GOV-D-009` | Aprovada; dependência satisfeita | `LVFI-APP-011` dependia da ENG-006; é agora a próxima task oficial, planejada e não iniciada | Product Owner, 2026-08-25 | A ENG-006 foi integrada no PR #20 sem mudar Método 1 `1.0.0` ou Engine `1.0.1`; APP-011 continua sem escopo adicional e exige autorização própria | decisão do Product Owner; PR #20 |
...
| Escopo técnico da APP-011 | Pendente; próxima task oficial, planejada e não iniciada | Product Owner/CTO | Não iniciar sem autorização própria | `GOV-D-004`, `GOV-D-009` |
