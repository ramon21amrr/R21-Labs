...
| `GOV-D-009` | Aprovada | `LVFI-APP-011` depende da conclusão da ENG-006 e permanece planejada/bloqueada | Product Owner, 2026-08-19 | A ENG-006 prepara posteriormente Handicap Asiático e Totais para comparação com mercado; APP-011 não recebe escopo adicional nesta decisão | decisão do Product Owner |
...
| Escopo técnico da APP-011 | Pendente; planejada e bloqueada pela ENG-006 | Product Owner/CTO | Não iniciar antes da conclusão da ENG-006 e de autorização própria | `GOV-D-004`, `GOV-D-009` |
