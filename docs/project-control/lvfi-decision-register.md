...
| `GOV-D-016` | Aprovada | O Product Owner confirmou a correção da fonte XLSM, aceitou a entrega da `R21-GOV-002` e autorizou seu commit local | Product Owner, 2026-09-06 | Permite registrar a unidade documental; push, PR e merge continuam sem autorização | decisão explícita do Product Owner; revalidação registrada no [documento 39](../products/linha-de-valor-football-intelligence/39-lvfi-master-plan-rebaseline.md) |
...
| ID e autorização da fundação operacional de dados | Pendente; primeira decisão após publicação da R21-GOV-002 | Product Owner/CTO | Bloqueia iniciar código do plano mestre | `GOV-D-010–015`; [documento 39](../products/linha-de-valor-football-intelligence/39-lvfi-master-plan-rebaseline.md) |
